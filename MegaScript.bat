...
:Phase3KaceUltra
	call :StartPhase
	call stuff\Phase3\phase34kace.bat > "C:\it folder\megascript progress report\!today!_!now! phase 3.txt"
	call :EndPhase
	exit /b

:Phase3ManualUltra
	call :StartPhase
	call stuff\Phase3\phase3.bat > "C:\it folder\megascript progress report\!today!_!now! phase 3.txt"
	call :EndPhase
	exit /b
