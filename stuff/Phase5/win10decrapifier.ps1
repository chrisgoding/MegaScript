...
$GoodApps =	"store|calculator|BangOlufsen|HPPrivacy|AdvancedMicroDevices|InputApp|sticky|Edge|Thunderbolt|windows.photos|KONICA|soundrecorder|mspaint|screensketch|Intel|HPPC|Extension|RemoteDesktop|WindowsAlarms|WindowsCamera|CheckPointVPN|printdialog|synaptics|ZuneMusic|ZuneVideo"
    ...
    <StartLayoutCollection>
      <defaultlayout:StartLayout GroupCellWidth="6" xmlns:defaultlayout="http://schemas.microsoft.com/Start/2014/FullDefaultLayout">
        <start:Group Name="" xmlns:start="http://schemas.microsoft.com/Start/2014/StartLayout">
          ...
          <start:DesktopApplicationTile Size="2x2" Column="2" Row="2" DesktopApplicationLinkPath="%ALLUSERSPROFILE%\Microsoft\Windows\Start Menu\Programs\System Tools\Devices and Printers.lnk" />
